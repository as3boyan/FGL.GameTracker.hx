 ...
 */class GameTracker extends EventDispatcher {
	static public var api(getApi, never) : GameTracker;
	 ...
	 */	static public function getApi() : GameTracker {
		if(_instance == null)  {
	 ...
	 */	public function beginGame(currentScore : Float = NaN, currentGameState : String = null, customMsg : String = null) : Void {
	 ...
	 */	public function endGame(currentScore : Float = NaN, currentGameState : String = null, customMsg : String = null) : Void {
		backupLastData(currentScore, currentGameState);
		if(!_inGame)  {
	 ...
	 */	public function beginLevel(newLevel : Int, currentScore : Float = NaN, currentGameState : String = null, customMsg : String = null) : Void {
		backupLastData(currentScore, currentGameState);
		if(!_inGame)  {
	 ...
	 */	public function endLevel(currentScore : Float = NaN, currentGameState : String = null, customMsg : String = null) : Void {
		backupLastData(currentScore, currentGameState);
		if(!_inLevel)  {
	 ...
	 */	public function checkpoint(currentScore : Float = NaN, currentGameState : String = null, customMsg : String = null) : Void {
		backupLastData(currentScore, currentGameState);
		if(!_inGame)  {
	...
	/**
        ...
        */	public function alert(customMsg : String = null, currentScore : Float = NaN, currentGameState : String = null) : Void {
		backupLastData(currentScore, currentGameState);
	...
	/**
        ...
        */	public function customMsg(customMsg : String = null, msgType : String = "custom", currentScore : Float = NaN, currentGameState : String = null) : Void {
		backupLastData(currentScore, currentGameState);
	...
	function addToMsgQueue(action : String, subaction : String, score : Float, gamestate : String, custom_msg : String) : Void {
		if(_isEnabled)  {
			...
			Reflect.setField(msg, "time", Math.floor((new Date().getTime() / 1000)));
	 ...
	 */	function backupLastData(currentScore : Float, currentGameState : String) : Void {
		// NaN is used here in place of null
